    ...
    <section className="panel-grid">
      ...
      <article className="panel-card">
        ...
        <p className="state-text">
          {t("settings.currentTheme", { theme: currentThemeLabel })}
        </p>
        <div className="theme-grid">
          <div
            className={`theme-card${theme === "soft-pink" ? " is-active" : ""}`}
          >
          ...
          <div
            className={`theme-card${theme === "soft-blue" ? " is-active" : ""}`}
          >
      ...
      <article className="panel-card">
        ...
        <p className="state-text">
          {t("settings.currentLanguage", { language: currentLanguageLabel })}
        </p>
        <div className="language-grid">
          <div
            className={`language-card${language === "zh-CN" ? " is-active" : ""}`}
          >
          ...
          <div
            className={`language-card${language === "en-US" ? " is-active" : ""}`}
          >
