          ...
          <svg class="lingjingsvg" width="263" height="82" viewBox="0 0 527 174" fill="none"
            ...
            <defs>
              <linearGradient id="paint0_linear_1302_2024" x1="6.21731e-10" y1="87" x2="664.38" y2="87.2527"
                ...
                <stop stop-color="var(--chat-gradient-start, #D0BCFF)" />
                <stop offset="1" stop-color="var(--chat-gradient-end, #E3E3E3)" />
              </linearGradient>
            </defs>
          </svg>
...
.status-icon {
  font-size: calc(var(--font-size-xxl) * 3.2);
  margin-bottom: 20px;
}
...
@media (max-width: 768px) {
  ...
  .status-icon {
    font-size: calc(var(--font-size-xxl) * 2.4);
  }
