<template>
  <div class="message-input-area" @paste="handlePaste" @dragover.prevent @drop.prevent="handleDrop">
    <!-- 附件预览（统一：粘贴/拖拽/选择加入，发送按钮时一次性发出为多事件） -->
...
.attachment-chip { display: inline-flex; align-items: center; gap: 8px; padding: 6px 8px; border: 1px solid var(--border-color); border-radius: 8px; background: var(--bg-color-third); }
...
.attachment-chip .file-icon { width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; border-radius: 4px; background: var(--bg-color); color: var(--text-color-secondary); font-size: var(--font-size-base); }
