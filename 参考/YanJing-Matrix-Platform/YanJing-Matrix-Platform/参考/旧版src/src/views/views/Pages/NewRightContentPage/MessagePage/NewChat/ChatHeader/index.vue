<template>
  <div class="chat-header">
    ...
    <div class="chat-header__right">
      ...
      <button v-if="isMobile" class="back-list-btn" type="button" @click.stop="handleBackToList"
        @touchend.stop.prevent="handleBackToList"
...
const setMobilePanel = inject<((panel: 'left' | 'center' | 'right') => void) | null>('setMobilePanel', null)
...
const isMobile = computed(() => Boolean(chatContext?.isMobile?.value))
...
const handleBackToList = () => {
  ...
  console.log('ChatHeader - 点击返回列表按钮，调用setMobilePanel切换到left面板', {
    hasSetMobilePanel: !!setMobilePanel
  })
  setMobilePanel?.('left')
  chatContext?.exitNewroomsMobile?.()
}
