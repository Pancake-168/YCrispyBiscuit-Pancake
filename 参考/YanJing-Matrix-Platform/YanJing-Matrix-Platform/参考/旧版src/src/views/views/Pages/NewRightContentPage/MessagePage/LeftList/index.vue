<template>
	<div class="room-list">
		<search @talk-request-from-organization-list="emitTalkRequest" />
...
const sortedRooms = computed(() => {
	...
	// 不做任何过滤：仅确保 room 存在（避免排序时报错）
	const sorted = [...props.rooms].filter(Boolean).sort((a, b) => {
...
const emitTalkRequest = (userid: string, createdRoomId?: string) => {
