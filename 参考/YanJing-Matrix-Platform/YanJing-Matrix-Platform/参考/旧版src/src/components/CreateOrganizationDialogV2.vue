<template>
    <Teleport to="body">
        <Transition name="dialog-fade">
            <div v-if="modelValue" class="create-organization-dialog-overlay" @click="handleOverlayClick">
                <div class="create-organization-dialog-content" @click.stop>
                    <!-- 弹窗头部 -->
...
import { CreateOrganizationApplicationMarket } from '@/services/Project/OrganizationV2/Application'
