...
//matrix的服务器地址
export const Login_MATRIX_SERVER_URL = 't8961.zheshu.tech';
export const Login_MATRIX_SERVER_URL_TAIL = ':t8961.zheshu.tech';
export const Login_MATRIX_SERVER_URL_ALL = 'https://t8961.zheshu.tech/';
...
export const MATRIX_SERVER_URL = Login_MATRIX_SERVER_URL;
export const MATRIX_SERVER_URL_TAIL = Login_MATRIX_SERVER_URL_TAIL;
export const MATRIX_SERVER_URL_ALL = Login_MATRIX_SERVER_URL_ALL;




// 允许的主机列表（用于 Vite 开发服务器）
...
// NocoBase 目标地址 (局域网)
export const NOCOBASE_URL = 'https://t8960.zheshu.tech/';

// Matrix 代理目标（用于开发环境代理媒体、API请求等）
export const matrixProxyTarget = 'https://t8961.zheshu.tech';


//后端业务基础地址
export const BASE_URL1 = 'https://t8962.zheshu.tech';  //旧版
export const BASE_URL2 ='https://testai.zheshu.tech'  //测试
export const BASE_URL3 ='https://apiv2.zheshu.tech'  //正式
...
export const API_URLS = {
  ...
  */
  ...
  GetWsConnection: (bot_account: string) => `wss://t8962.zheshu.tech/api/v2/ws/shayu/${bot_account}`,
   ...
   */
  //已使用
  WechatLoginUrl: () => `${BASE_URL3}/api/auth/wx/login:dev`,
  ...
  */
  ...
  //Bot token post请求
  //已使用
  ApplicationBotToken: (appid: string, bot_id: string) => `${BASE_URL}/api/v2/application/${appid}/bot/${bot_id}/token`,
...
/*
 ...
 //获取用户信息，能拿到matrix的ID
  ...
  // 创建房间，只针对非bot房间的二人间聊天，后端会把需要的bot加进去，因此避免前端重复创建不需要的房间
  CreateIMRoom: () => `${BASE_URL}/api/v2/im/room`,
