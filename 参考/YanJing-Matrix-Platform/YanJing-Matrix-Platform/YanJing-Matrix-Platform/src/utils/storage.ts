...
export async function getSetting<T = unknown>(key: string): Promise<T | null> {
    ...
    if (api) {
        try {
            ...
            console.warn('[System:storage:getSetting] Electron settings-get failed:', error)
        }
    }
...
export async function setSetting(key: string, value: unknown): Promise<boolean> {
    ...
    if (api) {
        try {
            ...
            console.warn('[System:storage:setSetting] Electron settings-set failed:', error)
        }
    }
...
export async function removeSetting(key: string): Promise<boolean> {
    ...
    if (api && 'removeSetting' in api && typeof api.removeSetting === 'function') {
        try {
            ...
            console.warn('[System:storage:removeSetting] Electron settings-remove failed:', error)
        }
    }
...
export async function getAllKeys(): Promise<string[]> {
    ...
    if (api) {
        try {
            ...
            console.warn('[System:storage:getAllKeys] Electron getAllKeys failed:', error)
        }
    }
