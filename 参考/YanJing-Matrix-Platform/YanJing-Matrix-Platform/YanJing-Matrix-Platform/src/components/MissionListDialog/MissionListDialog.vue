    ...
    <div class="dialog-mask yj-dialog-mask" @click.self="emit('close')">
        <div class="dialog yj-dialog-content">
            ...
            <div class="dialog-body">
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-title">创建新的任务</div>
                    ...
                    <div class="grid">
                        <div class="card" @click="handleTalk(userbot?.username)">
                            ...
                            <div class="info">
                                <div class="nickname" :title="userbot?.nickname || '通用助手'">{{ userbot?.nickname ||
                                    '通用助手' }}</div>
                ...
                <section class="section">
                    <div v-if="!botMembers.length" class="empty-text">暂无智能体</div>
                    <div v-else class="grid">
