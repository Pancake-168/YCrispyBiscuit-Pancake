            ...
            <div class="svg">
                <svg class="lingjingsvg" width="130" height="40" viewBox="0 0 527 174" fill="none"
                    ...
                    <path
                        ...
                        fill="url(#paint0_linear_register_form)" />
                    <defs>
                        <linearGradient id="paint0_linear_register_form" x1="6.21731e-10" y1="87" x2="664.38"
...
import type { MatrixRegisterConfig } from '@/types/matrix'
...
const handleSubmit = () => {
    ...
    if (!validateUsername(formData.username)) {
        showError('用户名只能包含小写字母、数字和下划线，长度3-32个字符')
        return
    }
    ...
    // 服务器地址验证
    if (!isValidUrl(formData.homeserver)) {
        showError('服务器地址为空')
        return
    }
...
console.log('[System:RegisterForm:onMounted] 组件挂载完成')
</script>
