<template>
    <div class="page-header">
        <div class="left">
            ...
            <div v-if="systemStore.currentFunction === 'Message'" class="icon drawer-left-icon"
                @click=" sidebarStore.toggleSidebar('sidebar1', 'left')">
                <img src="@/assets/Project/components/PageHeader/抽屉左.svg" alt="Logo" />
            </div>
            <div v-if="systemStore.currentFunction === 'Mission'" class="icon drawer-left-icon"
                @click=" sidebarStore.toggleSidebar('sidebar2', 'left')">
                <img src="@/assets/Project/components/PageHeader/抽屉左.svg" alt="Logo" />
            </div>
        ...
        <div class="right">
            ...
            <div v-if="systemStore.currentFunction === 'Message'" class="icon drawer-right-icon"
                @click=" sidebarStore.toggleSidebar('sidebar1', 'right')">
                <img src="@/assets/Project/components/PageHeader/抽屉右.svg" alt="Logo" />
            </div>
             <div v-if="systemStore.currentFunction === 'Mission'" class="icon drawer-right-icon"
                @click=" sidebarStore.toggleSidebar('sidebar2', 'right')">
                <img src="@/assets/Project/components/PageHeader/抽屉右.svg" alt="Logo" />
            </div>
             <!--div v-if="systemStore.currentFunction === 'Organization'" class="icon drawer-right-icon"
                @click=" sidebarStore.toggleSidebar('sidebar3', 'right')">
                <img src="@/assets/Project/components/PageHeader/抽屉右.svg" alt="Logo" />
            </div-->
...
import CurrentOrganization from '@/components/Organization/CurrentOrganization';
